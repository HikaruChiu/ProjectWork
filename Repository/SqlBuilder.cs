...
namespace Repository
{
    ...
    public class SqlBuilder
    {
        ...
        public class Template
        {
            ...
            private static readonly Regex _regex = new(@"\/\*\*.+?\*\*\/", RegexOptions.Compiled | RegexOptions.Multiline);
        ...
        public Template AddTemplate(string sql, dynamic parameters = null) => new(this, sql, parameters);
