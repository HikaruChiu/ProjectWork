...
namespace PJW.Web
{
    public class Startup
    {
        ...
        {
            //autofac打標籤模式 文件：https://github.com/yuzd/Autofac.Annotation
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var myConnectionConfig = new MyConnectionConfig();
            Configuration.GetSection("ConnectionStrings")
                .Bind(myConnectionConfig);

            services.AddSingleton(sectionConfig);
            services.AddSingleton(myConnectionConfig);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory logging)
        {
            ...
            #region AntORM
            //文件：https://github.com/yuzd/AntData.ORM
            app.UseAntData();
            #endregion
            ...
            HttpContext.ServiceProvider = this.AutofacContainer = app.ApplicationServices.GetAutofacRoot();
        }
